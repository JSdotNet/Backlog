...
> tools. Claude Code loads this rule through `.claude/rules/context-loading.md`, and
> `CLAUDE.md` at the repository root restates the gate in those terms. Keep both in step
...
context, per `.agents/rules/mcp-usage.md`.
