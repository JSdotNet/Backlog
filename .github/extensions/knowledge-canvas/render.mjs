...
<body>
<div id="layout">
  <div id="path-bar">No document open. Call <code>set_document</code> with a path under .domain/, .arc42/, .backlog/, or .tech/.</div>
  <div id="body">
...
async function loadDocument() {
  ...
  if (res.status === 404) {
    document.getElementById("path-bar").textContent = "No document open. Call set_document with a path under .domain/, .arc42/, .backlog/, or .tech/.";
