...
/// <para>
/// Workspace-level on purpose: <c>.backlog</c> is one of these configured
/// folders, so Backlog Management resolves its repository-authored entries
/// through the same lookup Second Brain uses for <c>.domain</c> or <c>.arc42</c>.
/// Leaving it inside either context would make the other one depend on it.
/// </para>
/// </summary>
