...
/// takeovers cannot coexist with each other. Tools is the Dev PC domain and
/// Dashboard is Monitoring's — opening either means the reader has stopped
/// looking at the backlog, so there is no arrangement in which one shares the
/// screen with the panes or with the other. Two booleans would have to be kept
/// out of the fourth state by hand; this cannot reach it.
/// </para>
/// <para>
...
internal enum WorkspaceSurface
{
    ...
    /// <summary>Monitoring, taking the whole screen.</summary>
    Dashboard
}
