...
/// so the app-shell footer can say which one you are looking at, in the place the
/// version occupies when it does not.
/// </para>
/// <para>
...
/// the shell's. Nothing registers it in an installed build, and the control then
