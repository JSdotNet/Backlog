...
public sealed record DevbookFileState(string Path, long Size, long Mtime, string SourceHash)
{
    /// <summary>
...
/// <see cref="DevbookRetrieval.UnavailableMessage"/>.</para>
/// </summary>
public enum DevbookRetrievalTier
{
...
public static class DevbookRetrieval
{
    ...
    /// </summary>
    public static DevbookRetrievalTier TierFor(DevbookDatabase? database) =>
        database is null
            ? DevbookRetrievalTier.Unavailable
            : database.HasEmbeddings
                ? DevbookRetrievalTier.FullTextAndSemantic
                : DevbookRetrievalTier.FullText;
