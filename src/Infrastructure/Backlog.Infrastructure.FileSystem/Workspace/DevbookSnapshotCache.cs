    ...
    IGitHubBranchCatalog branches) : IDevbookSnapshotCache
{
    ...
    public DevbookSnapshot? TryRead(GitHubRepositoryRef repository, string? branch)
    {
        ...
        try
        {
            ...
            return Directory.Exists(SnapshotPath(repository, branch))
                ? new DevbookSnapshot(stored.Branch, stored.Sha, stored.FetchedUtc)
                : null;
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return DevbookSnapshotResult.Failed(current, exception.Message);
        }
        ...
        {
            return new DevbookSnapshotResult(current, false, false, $"Up to date with {head.Branch}.");
        }
