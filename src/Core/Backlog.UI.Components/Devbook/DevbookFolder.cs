...
/// <summary>
/// Derives <see cref="DevbookFolder"/> from a reference path. The folder is
...
/// </summary>
public static class DevbookFolders
{
    /// <summary>
    ...
    /// </summary>
    public static DevbookFolder FromPath(string? path)
    {
        if (string.IsNullOrWhiteSpace(path)) return DevbookFolder.Unknown;
        ...
        {
            ".arc42" => DevbookFolder.Arc42,
            ".domain" => DevbookFolder.Domain,
