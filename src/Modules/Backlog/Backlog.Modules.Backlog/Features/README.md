...
- Its tests live in `tests/Backlog.Modules.Backlog.UnitTests`, mirroring this folder.

Once the first slice exists, slices are registered with the host through an
`Extensions/ServiceCollectionExtensions.cs` composition root (`AddBacklogModule()`).
