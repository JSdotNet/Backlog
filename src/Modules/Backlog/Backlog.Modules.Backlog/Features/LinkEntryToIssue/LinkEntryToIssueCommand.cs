...
namespace Backlog.Modules.Backlog.Features.LinkEntryToIssue;
...
/// </para>
/// </summary>
public sealed record LinkEntryToIssueCommand(Guid Id, string RepoId, string ExternalId, string TargetType);

public sealed class LinkEntryToIssueCommandHandler(IBacklogRepository entries)
    : ICommandHandler<LinkEntryToIssueCommand, Result<BacklogEntryDto>>
{
    ...
    public async Task<Result<BacklogEntryDto>> Handle(
        LinkEntryToIssueCommand command,
