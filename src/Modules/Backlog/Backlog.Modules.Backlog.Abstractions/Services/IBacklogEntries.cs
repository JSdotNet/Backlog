...
/// </para>
/// </summary>
public interface IBacklogEntries
{
    /// <summary>Everything in the backlog, in rank order.</summary>
    Task<IReadOnlyList<BacklogEntryDto>> ListAsync(CancellationToken cancellationToken = default);
    ...
    Task<Result<BacklogEntryDto>> LinkToIssueAsync(
        Guid id,
        string repoId,
        string externalId,
        string targetType,
