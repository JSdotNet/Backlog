...
/// </para>
/// </summary>
public sealed record BacklogRefreshSettings
{
...
/// <para>
/// A port on Backlog Management's own surface for the same reason
/// <see cref="IBacklogStore"/> and <see cref="IRoadmapTagSource"/> are: a screen
...
/// </para>
/// </summary>
public interface IBacklogRefreshSettings
{
    ...
    BacklogRefreshSettings Current { get; }
    ...
    /// <see cref="BacklogRefreshSettings.MinimumPollingIntervalSeconds"/> — a
