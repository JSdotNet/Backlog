...
public sealed class DevbookFolderOpenService(IDevbookFolderSource source, IFolderEditorLauncher launcher)
{
    public async Task OpenAsync(string areaKey, string? nodePath, string? repositoryAlias = null, CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new DevbookFolderOpenException(location.Message ?? $"{AreaLabel(areaKey)} is unavailable.");
        }
        ...
        catch (FolderEditorLaunchException ex)
        {
            ...
            throw new DevbookFolderOpenException(ex.Message, ex);
        }
    }
...
/// its message.
/// </summary>
public sealed class DevbookFolderOpenException : Exception
{
    public DevbookFolderOpenException(string message) : base(message) { }

    public DevbookFolderOpenException(string message, Exception innerException) : base(message, innerException) { }
}
