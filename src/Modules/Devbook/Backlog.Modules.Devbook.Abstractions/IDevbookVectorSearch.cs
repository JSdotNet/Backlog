...
/// vectors answers nothing here and <see cref="IDevbookSearch"/> still answers
/// everything. That is an empty result rather than
/// <see cref="DevbookSearchAnswer.Unavailable"/> — search by meaning being
...
/// </summary>
public interface IDevbookVectorSearch
{
    /// <summary>
