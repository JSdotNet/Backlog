...
/// omits it. There are eleven permitted fields in that record's table — ten here
...
/// </para>
/// <para>
/// Last, and defaulted, so a record written by a device that predates it
/// deserialises with the field absent rather than failing the page it arrived
/// in — the same reason <see cref="TurnCount"/> is nullable rather than zero.
/// </para>
/// </param>
...
/// <para>
/// <paramref name="MachineId"/> is the eleventh whitelisted field and the one the
