...
status: active
index: root
related: [".arc42/11-risks-and-technical-debt.md#technical-debt", ".arc42/adr/README.md"]
```
...
own *Deviations and gaps* section under `.arc42/adr/guidelines/`, beside the rule it
falls short of.
