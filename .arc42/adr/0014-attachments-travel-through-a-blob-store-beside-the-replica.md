...
status: active
date: 2026-09-25
related: [".arc42/07-deployment-view.md#cloud-deployment-azure", ".arc42/08-crosscutting-concepts.md#storage-and-sync", ".arc42/adr/0003-sqlite-is-the-canonical-local-task-store.md", ".arc42/adr/0005-azure-hosted-task-replica-for-multi-device-sync.md", ".arc42/adr/0009-captures-are-a-document-kind-on-the-replica.md", ".arc42/adr/guidelines/0003-aspire-for-web-services.md", ".arc42/adr/guidelines/0012-authentication-external-identity-providers.md", ".arc42/adr/guidelines/0013-authorization-zero-trust.md", ".arc42/adr/guidelines/0014-persistence-and-repository-boundaries.md", ".domain/capture/domain.md#capture", ".domain/inbox/domain.md#inbox-item"]
issue: null
```
...
inherited ADR 0014 under `.arc42/adr/guidelines/`, which is about persistence
...
**There is nowhere for the bytes to go.** `.arc42/07-deployment-view.md` states
