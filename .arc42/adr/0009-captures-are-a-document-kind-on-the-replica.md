...
status: active
date: 2026-09-15
related: [".arc42/08-crosscutting-concepts.md#storage-and-sync", ".arc42/08-crosscutting-concepts.md#task-sync", ".arc42/05-building-block-view.md#desktop-app", ".arc42/adr/0002-backlog-module-owns-the-entry-text-language.md", ".arc42/adr/0003-sqlite-is-the-canonical-local-task-store.md", ".arc42/adr/0005-azure-hosted-task-replica-for-multi-device-sync.md", ".arc42/adr/0006-additive-schema-bootstrapping-is-the-local-migration-mechanism.md", ".arc42/adr/guidelines/0005-modular-monolith-structure.md", ".arc42/adr/guidelines/0014-persistence-and-repository-boundaries.md", ".domain/inbox/domain.md#inbox-item", ".domain/inbox/flow.md", ".domain/inbox/dependencies.md", ".domain/capture/domain.md#capture"]
issue: null
```
...
inherited ADR 0009 under `.arc42/adr/guidelines/`, which is about feature
...
- **Captures never touch the task table.** The Inbox owns its own rows and its
  ...
  Inbox asks it to make — which is the boundary `.domain/context-map.md` always
