...
> Not yet implemented: the derived layer is currently twelve committed JSON files
> under `_meta/`, generated by `.github/tools/knowledge-meta/build.mjs`, and the
> knowledge panels re-parse the markdown on every load. This section records the
> intended arrangement; see
> `.arc42/adr/0004-knowledge-index-is-a-generated-local-database.md` for the
> reasoning and for the questions it leaves open.
