...
|---|---|---|---|---|
| [Tasks](../tasks/domain.md#task) | OHS + Published Language (Tasks = supplier) | Subscribes to status/projection events | `.domain/tasks/domain.md#statuschanged`, `.domain/tasks/domain.md#taskprojected`, `.domain/tasks/domain.md#taskcompleted` | Tasks status changes and projections produce progress signals. |
...
| GitHub (external) | ACL | Polling / webhook | `.domain/tasks/domain.md#statuschanged` | Issue status feeds progress signals and is compared against backlog status. |
