...
|---|---|---|---|---|
| [Tasks](../tasks/domain.md#task) | Partnership | Id-based cross-link and read-side embedding | `.domain/second-brain/domain.md#cross-linking` | Notes link to and embed tasks; a note can spawn a task when an action is identified. |
...
| [Tasks](../tasks/domain.md#task) | Partnership | Reference/embed read model plus bi-directional link | `.domain/second-brain/domain.md#cross-linking` | Relies on note content being embeddable and cross-queryable without sharing aggregates. |
