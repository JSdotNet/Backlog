...
|---|---|---|---|---|
| [Inbox](../inbox/domain.md#inbox-item) | OHS + Published Language (Capture = supplier) | Subscribes to async `ItemCaptured` | `.domain/capture/domain.md#itemcaptured` | Relies on the normalized capture shape (title, `body_md`, source, tags, `captured_at`) and preserved source link. |
