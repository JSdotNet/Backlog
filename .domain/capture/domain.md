...
type: domain-service
status: draft
related: [.domain/inbox/domain.md#inbox-item, .arc42/06-runtime-view.md#mobile-capture-and-sync, .arc42/06-runtime-view.md#ide-context-aware-capture]
```
...
type: domain-event
status: draft
related: [.domain/capture/domain.md#capture, .domain/inbox/domain.md#inbox-item]
```
