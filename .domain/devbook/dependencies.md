...
|---|---|---|---|---|
| [Tasks](../tasks/domain.md#task) | Partnership | Id-based cross-link and read-side embedding | `.domain/devbook/domain.md#cross-linking` | Notes link to and embed tasks; a note can spawn a task when an action is identified. |
