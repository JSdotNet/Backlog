...
| [Devbook](../devbook/domain.md#knowledge-note) | Customer/Supplier (Technology Stack = customer) | ADR links by id | `.domain/devbook/domain.md#knowledge-note` | Technology decisions link to ADRs for justification and history. |
