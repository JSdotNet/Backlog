...
related: [.domain/tasks/features.md#multi-repo-targeting, .domain/devbook/features.md#repository-knowledge-areas]
```
...
type: sub-feature
status: draft
related: [.domain/devbook/features.md#repository-knowledge-areas]
```
