...
/// placeholder.</para>
/// </summary>
public sealed class DevbookReferenceRelativeTests
{
    [Fact]
    public void A_link_to_another_context_resolves_against_the_document_it_was_written_in()
    {
        ...
        // resolved before.
        var reference = DevbookReference.ParseDevbookPath(
        ...
        Assert.Equal(DevbookFolder.Domain, reference.Folder);
    }
    ...
    public void A_link_already_written_from_the_repository_root_still_resolves_to_itself()
    {
        ...
        var reference = DevbookReference.ParseDevbookPath(".tech/shared.md", ".design/component-libraries.md");
    ...
    public void An_anchor_on_its_own_addresses_the_document_it_was_written_in()
    {
        ...
        // scrolls to it — see DevbookChapterLink.Anchor — but a reader who
    ...
    public void A_dot_folder_that_is_not_a_section_is_still_read_from_the_repository_root()
    {
        ...
        Assert.Null(DevbookReference.ParseDevbookPath(
    ...
    public void A_dot_folder_reads_the_same_written_as_a_link_or_as_a_code_span()
    {
        ...
        Assert.Null(DevbookReference.ParseDevbookPath(target));
        Assert.Null(DevbookReference.ParseDevbookPath(target, ".tech/shared.md"));
    }
    ...
    public void A_rooted_link_into_another_section_is_untouched_by_the_dot_rule()
    {
        ...
        var reference = DevbookReference.ParseDevbookPath(".tech/shared.md", ".domain/roadmap/features.md");
    ...
    public void A_dot_that_is_the_folder_the_author_is_in_stays_relative()
    {
        ...
        var reference = DevbookReference.ParseDevbookPath("./domain.md#roadmap-item", ".domain/roadmap/features.md");
    ...
    public void A_dot_folder_behind_a_here_marker_is_rooted_too()
    {
        ...
        Assert.Null(DevbookReference.ParseDevbookPath("./.github/copilot-instructions.md", ".design/accessibility.md"));
    }

    [Fact]
    public void Both_slash_directions_read_as_separators()
    {
        // A path written with backslashes is the same path. DevbookFolders
    ...
    {
        Assert.Null(DevbookReference.ParseDevbookPath(target, document));
    }
    ...
    public void Without_a_document_to_resolve_against_a_relative_link_stays_unresolved(string target)
    {
        ...
        // rather than a guess.
        Assert.Null(DevbookReference.ParseDevbookPath(target, null));
    }
    ...
    public void The_document_the_link_came_from_is_read_leniently()
    {
        ...
        var reference = DevbookReference.ParseDevbookPath("../tasks/domain.md", "/.domain/roadmap/features.md");
    ...
    public void The_reference_keeps_the_resolved_path_as_its_raw_form()
    {
        ...
        var reference = DevbookReference.ParseDevbookPath("../tasks/domain.md#priority", ".domain/roadmap/features.md");
