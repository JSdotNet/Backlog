...
/// </summary>
public sealed class DevbookStatusPillTests
{
    [Fact]
    ...
    public void With_a_folder_the_pill_wears_the_badge_that_folders_tone_maps_onto()
    {
        ...
        var pill = context.Render<DevbookStatusPill>(parameters => parameters
            ...
            .Add(p => p.Folder, DevbookFolder.Tech));
    ...
    public void A_status_the_folder_does_not_define_is_flagged_and_says_what_was_expected()
    {
        ...
        var span = pill.Find("span");
        Assert.Contains("devbook-status--unrecognised", span.ClassList);
    ...
    public void The_pill_renders_what_the_record_headline_renders()
    {
        ...
        var standalone = context.Render<DevbookStatusPill>(parameters => parameters
            .Add(p => p.Status, "shipped")
            .Add(p => p.Folder, DevbookFolder.Tech));
        ...
        Assert.Equal(
            ...
            inRecord.Find(".devbook-record__headline .badge--status").OuterHtml);
    }
