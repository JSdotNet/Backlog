...
/// </summary>
public sealed class DevbookTypeMarkerTests
{
    ...
    public void Every_value_the_vocabulary_publishes_has_a_glyph()
    {
        ...
        foreach (var value in DevbookTypeMarkers.All)
        {
            ...
            Assert.Contains($"devbook-type-marker--{value}", svg.ClassList);
    ...
    public void The_family_is_stroked_at_1_6_and_only_the_identity_dots_are_filled()
    {
        ...
        {
            var svg = context
                .Render<DevbookTypeMarker>(parameters => parameters.Add(mark => mark.Value, value))
                .Find("svg");
    ...
    public void A_value_is_recognised_however_it_was_spaced_or_cased()
    {
        ...
        Assert.Contains("devbook-type-marker--value-object", marker.Find("svg").ClassList);
        Assert.True(DevbookTypeMarkers.IsRecognised("  Value-Object "));
        Assert.False(DevbookTypeMarkers.IsRecognised("value object"));
        Assert.False(DevbookTypeMarkers.IsRecognised(null));
    }
    ...
    public void A_heading_that_leads_with_a_mark_is_announced_with_it_and_still_reads_as_itself()
    {
        ...
        var marked = context.Render<DevbookTypeMarkerHeadingHarness>(parameters => parameters
        ...
        var plain = context.Render<DevbookTypeMarkerHeadingHarness>(parameters => parameters
    ...
    public void The_tooltip_can_be_declined_without_giving_up_the_name()
    {
        ...
        {
            var svg = context
                .Render<DevbookTypeMarker>(parameters => parameters
                    .Add(mark => mark.Value, value)
                    .Add(mark => mark.Labelled, true)
    ...
    public void Size_is_an_em_by_default_so_the_mark_scales_with_its_heading()
    {
        ...
        var scaled = context
            .Render<DevbookTypeMarker>(parameters => parameters.Add(mark => mark.Value, "entity"))
            .Find("svg");
    ...
    public void A_caller_class_is_appended_and_never_displaces_the_ones_the_stylesheet_matches()
    {
        ...
        var svg = context
            .Render<DevbookTypeMarker>(parameters => parameters
                ...
                .Add(mark => mark.CssClass, "devbook-type-marker--leads")
                .Add(mark => mark.TestId, "chapter-mark")
                .AddUnmatched("data-role", "type"))
            .Find("svg");

        Assert.Equal(
            "devbook-type-marker devbook-type-marker--flow devbook-type-marker--leads",
