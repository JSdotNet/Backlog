...
/// </summary>
public sealed class FileViewDevbookTests
{
    ...
    public void The_files_own_status_is_drawn_in_the_header_beside_its_name()
    {
        ...
        Assert.Empty(view.FindAll(".file-view__body .devbook-record"));
    }
    ...
    public void Without_being_asked_the_fence_is_the_code_block_it_has_always_been()
    {
        ...
        Assert.Empty(view.FindAll(".file-view__header .devbook-record"));
    }
    ...
    public void Nothing_here_writes_the_status_it_reports()
    {
        ...
        var view = Render(context, parameters => parameters
            .Add(v => v.RenderDevbookMetadata, true)
            .Add(v => v.DevbookFolder, DevbookFolder.Tech)
            .Add(v => v.OnDevbookStatusChanged, EventCallback.Factory.Create<DevbookStatusChange>(this, _ => { })));
        ...
        Assert.Equal("shared-technologies.md", view.Find(".devbook-record__headline h3.file-view__name").TextContent);
    }
    ...
    public void Offering_to_add_a_remark_does_not_cost_the_chapter_its_status()
    {
        ...
        Assert.NotNull(view.Find(".file-view__header .devbook-record__headline .badge--status"));
        Assert.Empty(view.FindAll("pre.md-code"));
    }
    ...
    public void The_document_a_link_resolves_against_is_the_one_the_host_named()
    {
        ...
        view.Find(".file-view__body button.devbook-ref--action").Click();
