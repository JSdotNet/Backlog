...
/// <c>&lt;code&gt;</c>.</para>
/// </summary>
public sealed class MarkdownViewDevbookLinkTests
{
    [Fact]
    ...
    public void A_markdown_link_into_the_knowledge_folders_navigates_inside_the_app()
    {
        ...
        var button = view.Find("button.devbook-ref--action");
    ...
    {
        // No href and no handler: the same bargain DevbookReferenceLink already
        ...
        Assert.Equal(".tech/shared.md", view.Find("code.devbook-ref--inert").TextContent);
        Assert.Empty(view.FindAll("button.devbook-ref--action"));
    }
    ...
    public void A_relative_link_navigates_to_the_chapter_it_resolves_to()
    {
        ...
        var view = Render(
            ...
            parameters => parameters
                .Add(v => v.RenderDevbookMetadata, true)
                .Add(v => v.DevbookDocumentPath, ".domain/roadmap/features.md")
                .Add(v => v.OnDevbookNavigate, EventCallback.Factory.Create<DevbookReference>(this, followed.Add)));
    ...
    public void An_anchor_on_its_own_resolves_to_the_chapter_that_is_open()
    {
        ...
        var view = Render(
            ...
            parameters => parameters
                .Add(v => v.RenderDevbookMetadata, true)
                .Add(v => v.DevbookDocumentPath, ".design/component-libraries.md")
                .Add(v => v.OnDevbookNavigate, EventCallback.Factory.Create<DevbookReference>(this, followed.Add)));
    ...
    public void A_link_into_a_dot_folder_that_is_not_a_section_is_inert_like_its_code_span_is()
    {
        ...
        var view = Render(
            ...
            parameters => parameters
                .Add(v => v.RenderDevbookMetadata, true)
                .Add(v => v.DevbookDocumentPath, ".design/component-libraries.md")
                .Add(v => v.OnDevbookNavigate, EventCallback.Factory.Create<DevbookReference>(this, _ => { })));
    ...
    public void The_document_path_alone_says_this_is_a_knowledge_document()
    {
        ...
        var view = Render(
            ...
            parameters => parameters
                .Add(v => v.DevbookDocumentPath, ".github/instructions/ui-components.instructions.md")
                .Add(v => v.OnDevbookNavigate, EventCallback.Factory.Create<DevbookReference>(this, followed.Add)));
