...
/// </summary>
internal static class DevbookCorpus
{
    ...
    public static Seeded Seed(string databasePath, string repositoryRoot, string? markdown = null)
    {
        ...
        var seeded = new Seeded(
            ...
            info.Length,
            DevbookFileState.UnixMilliseconds(info.LastWriteTimeUtc));
    ...
    private static void Fill(SqliteConnection connection, Seeded seeded)
    {
        Run(
            connection,
            "INSERT INTO meta (key, value) VALUES ('generatedBy', 'tools/devbook/build-database.mjs')");
        Run(
            connection,
