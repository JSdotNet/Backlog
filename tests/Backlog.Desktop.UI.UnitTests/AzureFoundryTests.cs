...
/// is the step that would compute vectors for the corpus: the database's one
/// writer is <c>DevbookDatabaseBuilder</c> (local ADR 0015), which computes none
/// yet, and nothing here opens that file at all.</para>
///
