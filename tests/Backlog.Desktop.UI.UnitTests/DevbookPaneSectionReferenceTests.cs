...
/// </para>
/// </summary>
public sealed class DevbookPaneSectionReferenceTests : IDisposable
{
    ...
    public async Task A_reference_in_a_design_chapter_opens_the_chapter_it_names()
    {
        ...
        component.WaitForAssertion(() => Assert.Contains(
            "Component Libraries",
            component.Find(".devbook-menu__item--active").TextContent,
    ...
    private Harness CreateHarness()
    {
        ...
        // `TechnologyDevbookTests`, `TechnologyDevbookPanelTests` and
        // `Arc42DevbookTests` each write an index fixture and assert the order
