...
public sealed class BacklogRoadmapTagOptionsTests
{
    ...
    private static IReadOnlyList<SelectorOption> TagOptions(IRenderedComponent<BacklogPane> pane) =>
...
public sealed class RoadmapPlanTagSourceTests : IDisposable
{
    ...
    public RoadmapPlanTagSourceTests()
    {
        ...
        _source = new RoadmapPlanTagSource(BacklogTestHost.PlanningFor(_settings));
    }
    ...
    {
        var planning = BacklogTestHost.PlanningFor(_settings);
