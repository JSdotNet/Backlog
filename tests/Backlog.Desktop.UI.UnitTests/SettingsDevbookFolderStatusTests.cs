...
/// <para>
/// The existence check is asked of <see cref="IDevbookFolderSource"/> rather
...
/// </para>
/// </summary>
public sealed class SettingsDevbookFolderStatusTests
{
    [Fact]
    ...
    public void A_section_whose_folder_is_in_the_clone_is_marked_in_the_field_rather_than_in_words()
    {
        ...
        Assert.Contains("devbook-folder__marker--found", marker.ClassName, StringComparison.Ordinal);
        ...
        Assert.Equal("devbook-folder-path-input", marker.ParentElement!.ParentElement!.QuerySelector("input")!.GetAttribute("data-testid"));
    ...
    public void A_section_whose_folder_is_absent_names_the_path_that_was_looked_at()
    {
        ...
        Assert.Contains("devbook-folder__marker--missing", marker.ClassName, StringComparison.Ordinal);
    ...
    public void A_section_turned_off_is_not_checked_for_a_folder_at_all()
    {
        ...
        Row(settings.Component, ".arc42").QuerySelector("[data-testid='devbook-folder-enabled']")!.Change(false);
    ...
    private static IElement Row(IRenderedComponent<Settings> component, string key) =>
        component.FindAll("[data-testid='devbook-folder-row']")
            .Single(row => row.QuerySelector(".devbook-folder__toggle code")!.TextContent == key);

    private static IElement Status(IRenderedComponent<Settings> component, string key) =>
        Row(component, key).QuerySelector("[data-testid='devbook-folder-status']")!;
