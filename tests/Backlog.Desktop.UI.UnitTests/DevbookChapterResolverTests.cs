...
/// </para>
/// </summary>
public sealed class DevbookChapterResolverTests : IDisposable
{
    ...
    public void An_arc42_document_path_resolves_with_its_area_prefix()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("arc42", root, ".arc42/08-crosscutting-concepts.md");
    ...
    public void An_arc42_menu_path_resolves_without_the_area_prefix()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("arc42", root, "08-crosscutting-concepts.md");
    ...
    public void A_nested_arc42_decision_record_resolves()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("arc42", root, ".arc42/adr/0001-use-markdown.md");
    ...
    public void A_domain_selection_drops_its_heading_anchor()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("domain", root, ".domain/context-map.md#devbook");
    ...
    public void A_technology_layer_file_name_resolves_against_the_tech_folder()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("tech", root, "frontend.md");
    ...
    public void A_design_file_name_resolves_against_the_design_folder()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("design", root, "interaction-guidelines.md");
    ...
    public void An_instruction_document_resolves_against_the_repository_root_with_its_leading_dot_folder()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("instructions", root, ".github/copilot-instructions.md");
    ...
    public void An_instruction_selection_naming_agent_finds_the_agents_folder()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("instructions", root, ".agent/review.md");
    ...
    public void A_configured_folder_key_names_the_same_area_as_its_menu_key()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve(".domain", root, "context-map.md");
    ...
    public void A_configured_folder_resolves_a_selection_that_carries_its_whole_path()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("arc42", root, "docs/arch/08-concepts.md", "docs/arch");
    ...
    {
        // What Arc42DevbookReader emits for a folder configured off the clone
        ...
        var chapter = DevbookChapterResolver.TryResolve("arc42", root, "arch/08-concepts.md", "docs/arch");
    ...
    public void A_configured_folder_resolves_an_unprefixed_menu_selection()
    {
        ...
        var chapter = DevbookChapterResolver.TryResolve("arc42", root, "08-concepts.md", "docs/arch");
    ...
    public void A_configured_folder_still_answers_to_the_areas_conventional_name()
    {
        ...
        Assert.Equal("context-map.md", DevbookChapterResolver.TryResolve("domain", domainRoot, ".domain/context-map.md")?.RelativePath);
        Assert.Equal("interaction-guidelines.md", DevbookChapterResolver.TryResolve("design", designRoot, "interaction-guidelines.md")?.RelativePath);
    }
    ...
    public void A_folder_configured_at_its_conventional_path_resolves_the_way_it_always_did()
    {
        ...
        Assert.Equal("08-crosscutting-concepts.md", DevbookChapterResolver.TryResolve("arc42", root, ".arc42/08-crosscutting-concepts.md", ".arc42")?.RelativePath);
        Assert.Equal("08-crosscutting-concepts.md", DevbookChapterResolver.TryResolve("arc42", root, "arc42/08-crosscutting-concepts.md", ".arc42")?.RelativePath);
        Assert.Equal("08-crosscutting-concepts.md", DevbookChapterResolver.TryResolve("arc42", root, "08-crosscutting-concepts.md", ".arc42")?.RelativePath);
    }
    ...
    public void A_configured_folder_does_not_widen_what_counts_as_inside_the_root()
    {
        ...
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, "../secrets.md", "docs/arch"));
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, Path.Combine(parent, "secrets.md"), "docs/arch"));
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, "99-not-written-yet.md", "docs/arch"));
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, "adr", "docs/arch"));
    }
    ...
    {
        var root = Area("docs/arch", "08-concepts.md");
        var folder = new DevbookFolderSetting(".arc42", "Architecture", ".arc42") { Path = "docs/arch" };
        var location = new DevbookFolderLocation(".arc42", true, null, "JSdotNet/Backlog", folder, root);

        Assert.Equal("08-concepts.md", DevbookChapterResolver.TryResolve("arc42", location, "docs/arch/08-concepts.md")?.RelativePath);
        Assert.Equal("08-concepts.md", DevbookChapterResolver.TryResolve("arc42", location, "arch/08-concepts.md")?.RelativePath);
        Assert.Equal("08-concepts.md", DevbookChapterResolver.TryResolve("arc42", location, "08-concepts.md")?.RelativePath);
        Assert.Equal(Path.Combine(root, "08-concepts.md"), DevbookChapterResolver.TryResolve("arc42", location, "arch/08-concepts.md")?.FullPath);
    }

    [Fact]
    public void An_empty_root_resolves_to_nothing()
    {
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", (string?)null, "08-crosscutting-concepts.md"));
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", "   ", "08-crosscutting-concepts.md"));
    }
    ...
    public void A_selection_that_climbs_out_of_the_root_resolves_to_nothing()
    {
        ...
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, "../secrets.md"));
    }
    ...
    public void An_absolute_selection_outside_the_root_resolves_to_nothing()
    {
        ...
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, outside));
    }
    ...
    public void A_selection_with_no_file_behind_it_resolves_to_nothing()
    {
        ...
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, "99-not-written-yet.md"));
    }
    ...
    public void A_folder_selection_resolves_to_nothing()
    {
        ...
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, "adr"));
    }
    ...
    public void An_empty_selection_resolves_to_nothing()
    {
        ...
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, null));
        Assert.Null(DevbookChapterResolver.TryResolve("arc42", root, "   "));
    }
    ...
    {
        var root = Area(".arc42", "08-crosscutting-concepts.md");
        var location = new DevbookFolderLocation(".arc42", true, null, "JSdotNet/Backlog", null, root);

        var chapter = DevbookChapterResolver.TryResolve("arc42", location, ".arc42/08-crosscutting-concepts.md");
    ...
    {
        var root = Area(".arc42", "08-crosscutting-concepts.md");
        var location = DevbookFolderLocation.Unavailable(".arc42", "Architecture knowledge is turned off.", fullPath: root);
    ...
    {
        var dir = Path.Combine(Path.GetTempPath(), "devbook-chapter-resolver-tests", Guid.NewGuid().ToString("N"));
