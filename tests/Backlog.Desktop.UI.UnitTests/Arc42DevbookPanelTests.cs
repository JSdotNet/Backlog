...
/// </para>
/// </summary>
public sealed class Arc42DevbookPanelTests : IDisposable
{
    ...
    public async Task Edit_puts_the_editing_surface_in_the_file_views_own_body()
    {
        ...
        component.WaitForAssertion(() => Assert.Single(component.FindAll("[data-testid='arc42-chapter-file-body'] [data-testid='devbook-chapter-surface']")));
    ...
    public async Task The_selected_chapter_is_shown_through_the_shared_file_view()
    {
        ...
        Assert.Empty(component.FindAll(".devbook-document__path"));
    }
    ...
    public async Task The_status_the_body_shows_is_not_offered_a_second_time_beside_it()
    {
        ...
        Assert.Empty(component.FindAll("[data-testid='arc42-chapter-file-body'] .devbook-record"));
    ...
    public async Task A_chapter_that_stops_being_readable_under_an_open_editor_falls_back_to_the_read_view()
    {
        ...
        component.WaitForAssertion(() =>
        {
            Assert.Empty(component.FindAll("[data-testid='arc42-chapter-file-body'] [data-testid='devbook-chapter-surface']"));
            Assert.Contains(
                "Original prose.",
                component.Find("[data-testid='arc42-chapter-file-body'] .devbook-p").TextContent,
