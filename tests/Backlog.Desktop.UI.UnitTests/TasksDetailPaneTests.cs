...
public sealed class TasksDetailPaneTests
{
    ...
    private static async Task AddTagAsync(IRenderedComponent<TasksPane> pane, string tag)
    {
    ...
    public async Task The_status_reads_on_the_heading_line_and_on_the_row()
    {
        ...
        // be beside the title: TasksRowPickersTests pins its absence, because a
