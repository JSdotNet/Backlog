...
public sealed class DevbookAtlasDatabaseTests : IDisposable
{
    ...
    public async Task A_folder_scope_draws_from_the_database_and_keeps_its_boundary_nodes()
    {
        ...
        var service = new DevbookAtlasService(source);
    ...
    public async Task The_whole_repository_scope_keeps_every_folder()
    {
        ...
        var graph = await service.ReadAsync(DevbookAtlasScope.All, null, TestContext.Current.CancellationToken);
    ...
    private IDevbookFolderSource Arrange(bool withDatabase)
    {
        ...
        return new FixedDevbookFolderSource(_root);
    }
    ...
    private sealed class FixedDevbookFolderSource(string root) : IDevbookFolderSource
    {
        ...
        public DevbookFolderLocation Resolve(string key, string? repositoryAlias = null)
        {
            ...
            return setting is null
                ? DevbookFolderLocation.Unavailable(key, "Not configured.")
