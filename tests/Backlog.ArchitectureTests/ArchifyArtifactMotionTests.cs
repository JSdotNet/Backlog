...
public class ArchifyArtifactMotionTests
{
    ...
    /// <summary>The storybook's one fixture artifact — the component map the
    /// Diagrams page hands to DiagramView — which is authored the same way and
    /// regenerated by the same procedure but sits outside the knowledge folders.</summary>
    private static readonly string[] StorybookFolder =
        ["src", "Harness", "Backlog.UI.Storybook", "Components", "Shared", "Archify"];
