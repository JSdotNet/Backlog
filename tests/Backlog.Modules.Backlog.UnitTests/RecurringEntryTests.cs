...
/// </summary>
public sealed class RecurringEntryTests
{
    [Fact]
    ...
    private sealed class InMemoryBacklogRepository : IBacklogRepository
    {
        public Dictionary<Guid, BacklogEntry> Entries { get; } = [];
        ...
        public BacklogEntry Successor(Guid completedId) =>
        ...
        public Task<IReadOnlyList<BacklogEntrySummary>> ListAsync(CancellationToken cancellationToken = default) =>
            Task.FromResult<IReadOnlyList<BacklogEntrySummary>>([]);
    }
}
