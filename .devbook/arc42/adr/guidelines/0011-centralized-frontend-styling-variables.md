...
- `.devbook/design/color-scheme.md` is the human-readable statement of the same tokens;
  `components.css` is where they bind.
- Backlog is **dark mode only** by product decision (`.devbook/design/design-principles.md`),
