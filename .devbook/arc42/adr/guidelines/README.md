...
- **`.devbook/arc42/adr/guidelines/`** (here) — decisions Backlog **inherited**. They
  apply to more repositories than this one; the numbering is the organization's.
- **`.devbook/arc42/adr/*.md`** — decisions Backlog **took for itself**, in its own
...
- **`.devbook/arc42/09-architecture-decisions.md`** — the chapter that links to both and
...
- To record that Backlog does something different, edit the *Deviations and gaps*
  section of the file, or write a local ADR in `.devbook/arc42/adr/` when the divergence
