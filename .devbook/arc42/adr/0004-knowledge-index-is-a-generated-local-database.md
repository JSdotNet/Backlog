...
`.devbook/arc42/adr/guidelines/`. Every reference below to ADR 0001–0004 without a
...
- The Desktop App diagram in `.devbook/arc42/05-building-block-view.md` still shows
