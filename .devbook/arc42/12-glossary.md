...
in `.devbook/arc42/08-crosscutting-concepts.md#shared-data-types`, which links out to
the owning chapter in `.devbook/domain` for each type instead of restating fields here.
