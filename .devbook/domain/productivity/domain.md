...
type: aggregate
status: draft
related: [.devbook/domain/tasks/domain.md#aiworklogged, .devbook/domain/monitoring/domain.md#progress-signal]
...
related: [.devbook/domain/productivity/features.md#ai-productivity-tracking]
```
