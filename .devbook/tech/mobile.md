...
```meta
status: adopted
related: [".devbook/tech/technology-graph.md", ".devbook/arc42/04-solution-strategy.md#technology-choices"]
```
...
status: adopted
type: platform
related: [".devbook/tech/cloud.md#firebase-cloud-messaging", ".devbook/tech/shared.md#net-maui"]
```

The primary mobile target platform; the platform head that `.devbook/tech/shared.md#net-maui`
...
documented once in `.devbook/tech/shared.md#net-maui` and `.devbook/tech/shared.md#blazor-hybrid`,
since the desktop channel now uses the same framework
(`.devbook/arc42/adr/0001-desktop-stack-maui-blazor-hybrid.md`).
...
status: adopted
type: tool
depends-on: [".devbook/tech/mobile.md#android", ".devbook/tech/mobile.md#java-jdk"]
related: [".devbook/tech/mobile.md#apk-packaging"]
```
...
status: adopted
type: tool
depends-on: [".devbook/tech/mobile.md#android", ".devbook/tech/mobile.md#android-sdk-build-tools"]
related: [".devbook/arc42/07-deployment-view.md#installation-and-updates-mobile"]
```
